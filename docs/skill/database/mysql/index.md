...
-- 修改用户名与命名
UPDATE `user` SET `username`='Se7en',`password`='a12345678` WHERE id = 1
```
...
![img](https://img.Se7en.cn/20201009150524563.png)
...
SELECT LOWER('Se7en') --到小写
SELECT UPPER('Se7en') --到大写
```
...
![image-20210102213536190](https://img.Se7en.cn/image-20210102213536190.png)
